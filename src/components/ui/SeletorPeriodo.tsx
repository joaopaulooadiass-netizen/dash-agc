...
export function SeletorPeriodo({ de, ate, onDe, onAte, atalhos = [7, 30, 60, 90], minData, maxData }: Props) {
  ...
  return (
    <div ref={ref} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', position: 'relative' }}>
      ...
      <style>{`
        .rdp-root {
          --rdp-accent-color: #CC9B49;
          --rdp-accent-background-color: rgba(204,155,73,0.16);
          color: var(--color-text-primary);
          font-family: var(--font-body);
        }
        .rdp-range_middle, .rdp-range_start, .rdp-range_end { background: rgba(204,155,73,0.16) !important; border-radius: 0 !important; }
        ...
        .rdp-selected .rdp-day_button, .rdp-selected .rdp-day_button:hover { background-color: #CC9B49 !important; color: white !important; border: none !important; }
        ...
        .rdp-range_start .rdp-day_button, .rdp-range_end .rdp-day_button { background-color: #CC9B49 !important; color: white !important; border: none !important; }
