...
const usuarios = [
  { id: 1, nome: 'Gabriel Roberto', papel: 'Cliente',        cor: '#CC9B49' },
  { id: 2, nome: 'João Paulo',      papel: 'Gestor',         cor: '#818cf8' },
]
...
function CopyBtn({ text, size = 'sm' }: { text: string; size?: 'sm' | 'xs' }) {
  ...
  return (
    <button onClick={copy} style={{
      ...
      border: `1px solid ${ok ? 'rgba(34,197,94,0.3)' : 'var(--color-border-default)'}`,
      background: ok ? 'rgba(34,197,94,0.08)' : 'var(--color-bg-tertiary)',
...
function BlocoAparencia() {
  return (
    <Card>
      <Row
        label="Tema"
        sub="Modo escuro — modo claro em breve"
        right={
          <>
            <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', color: 'var(--color-text-muted)' }}>
              Escuro
            </span>
            <Chip label="Em breve" color="#818cf8" bg="rgba(129,140,248,0.1)" border="rgba(129,140,248,0.2)" />
          </>
        }
        last
      />
  ...
  return (
    <Card>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
          <Chip label="Ativo" color="#22c55e" bg="rgba(34,197,94,0.1)" border="rgba(34,197,94,0.2)" />
      ...
      <div style={{
        ...
        {mcpTools.map(t => (
          <div key={t.nome} style={{
            ...
            <code style={{ fontFamily: 'monospace', fontSize: '0.68rem', color: '#CC9B49', display: 'block', marginBottom: 3 }}>
              {t.nome}
            </code>
        ...
        <div style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
              ...
              <Chip label="Aguardando deploy" color="#eab308" bg="rgba(234,179,8,0.1)" border="rgba(234,179,8,0.2)" />
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
              {[
                { label: 'Name',                  value: 'Dashboard Copy que Vende',                 mono: false },
