...
const Q_COR: Record<string, string> = {
  acima: '#22C55E', abaixo: '#94A3B8', novo: '#60A5FA',
}
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1.25rem 2rem 0', flexWrap: 'wrap', gap: '0.75rem', flexShrink: 0 }}>
        ...
        <div style={{ display: 'flex', gap: '0.6rem', flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <button
            ...
            style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '0.3rem 0.75rem', backgroundColor: filtroAtivo ? 'rgba(204,155,73,0.12)' : 'var(--color-bg-card)', border: `1px solid ${filtroAtivo ? 'var(--color-ponto-conversao)' : 'var(--color-border-subtle)'}`, borderRadius: 'var(--radius-md)', fontFamily: 'var(--font-body)', fontSize: '0.74rem', color: filtroAtivo ? 'var(--color-ponto-conversao)' : 'var(--color-text-muted)', cursor: 'pointer', fontWeight: filtroAtivo ? 700 : 400 }}
          >
            <span>⚙</span>
            Filtros{filtroAtivo ? ' ●' : ''}
          </button>
          ...
          <div style={{ backgroundColor: 'var(--color-bg-card)', border: '1px solid var(--color-border-subtle)', borderRadius: 'var(--radius-lg)', padding: '1rem 1.25rem', flexShrink: 0 }}>
            ...
            <ResponsiveContainer width="100%" height={230}>
              <ScatterChart margin={{ top: 20, right: 36, left: 0, bottom: 16 }} onClick={(e) => {
                ...
                <ReferenceLine x={mediaX} stroke="rgba(255,255,255,0.15)" strokeDasharray="4 4" label={{ value: 'média', position: 'top', fill: 'rgba(255,255,255,0.3)', fontSize: 9 }} />
                <ReferenceLine y={mediaY} stroke="rgba(255,255,255,0.15)" strokeDasharray="4 4" label={{ value: 'média', position: 'right', fill: 'rgba(255,255,255,0.3)', fontSize: 9 }} />
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: isOver ? 'rgba(204,155,73,0.12)' : 'var(--color-bg-card)',
