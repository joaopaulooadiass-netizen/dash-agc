...
export const DASHBOARD_METRICS: MetricDefinition[] = [
  ...
  metric('impressoes', 'Impressões', 'Veiculação', 'number', ['global', 'criativos', 'campanhas', 'diaria', 'funil'], row => numberValue(row, 'impressoes'), { defaultScopes: ['campanhas', 'diaria'], cor: '#475569' }),
  ...
  metric('cliques', 'Cliques', 'Veiculação', 'number', ['global', 'campanhas', 'diaria', 'funil'], row => numberValue(row, 'cliques'), { defaultScopes: ['campanhas', 'diaria'], cor: '#60A5FA' }),
  ...
  metric('pageView', 'Page View', 'Página', 'number', ['global', 'campanhas', 'diaria', 'funil'], row => numberValue(row, 'pageView'), { cor: '#818CF8' }),
  ...
  metric('viewContent', 'View Content', 'Página', 'number', ['campanhas', 'criativos'], row => numberValue(row, 'viewContent'), { cor: '#A78BFA' }),
  ...
  metric('inicioCheckout', 'Início de Checkout', 'Conversão', 'number', ['funil'], row => firstNumber(row, 'inicioCheckout', 'checkout'), { cor: '#F59E0B' }),
  metric('compras', 'Compras', 'Conversão', 'number', ['global', 'criativos', 'campanhas', 'tendencias', 'funil'], row => firstNumber(row, 'compras', 'vendas', 'conversoes'), { defaultScopes: ['criativos', 'campanhas'], cor: '#22C55E' }),
  metric('leads', 'Leads', 'Conversão', 'number', ['funil'], row => numberValue(row, 'leads'), { cor: '#A78BFA' }),
  ...
  metric('seguidores', 'Seguidores', 'Engajamento', 'number', ['global', 'criativos', 'campanhas', 'diaria', 'funil'], row => firstNumber(row, 'seguidores'), { defaultScopes: ['campanhas'], colorScopes: ['campanhas'], cor: '#FB923C' }),
