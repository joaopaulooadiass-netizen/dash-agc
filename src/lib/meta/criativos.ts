...
const THUMB_COLORS = [
  'linear-gradient(135deg, #CC9B49 0%, #4B0011 100%)',
  'linear-gradient(135deg, #1e3a5f 0%, #0f1e33 100%)',
  'linear-gradient(135deg, #2d1b69 0%, #11052c 100%)',
  'linear-gradient(135deg, #7c3aed 0%, #1e0a4a 100%)',
  'linear-gradient(135deg, #065f46 0%, #022c22 100%)',
  'linear-gradient(135deg, #92400e 0%, #451a03 100%)',
  'linear-gradient(135deg, #1e40af 0%, #0a1628 100%)',
  'linear-gradient(135deg, #6b21a8 0%, #2e1065 100%)',
]
